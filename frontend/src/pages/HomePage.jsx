      ...
      <div className="space-y-4 rounded-xl border border-border bg-card p-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-border bg-background py-2 pl-10 pr-3 text-sm outline-none ring-indigo-300 transition focus:ring-2"
          />
        </div>

        <div className="space-y-1">
          <div className="flex items-center justify-between text-xs text-muted-foreground">
            <label htmlFor="search-threshold" className="font-medium text-slate-700 dark:text-slate-300">Minimum relevance threshold</label>
            <span>{threshold}%</span>
          </div>
          <input
            id="search-threshold"
